...
VALUES
(DEFAULT,433014,'Azami, Lady of Scrolls',(select id from card_types where card_types = 'Creature'),'{2}{U}{U}{U}',5,0,2,'Tap an untapped Wizard you control: Draw a card.', (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp(), (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp()),
(DEFAULT,461156,'Dovin, Hand of Control',(select id from card_types where card_types = 'Planeswalker'),'{2}{W/U}',3,'','','Artifact, instant, and sorcery spells your opponents cast cost {1} more to cast.
...
(DEFAULT,460988,'Narset, Parter of Veils',(select id from card_types where card_types = 'Planeswalker'),'{1}{U}{U}',3,'','','Each opponent can''t draw more than one card each turn.
...
(DEFAULT,461112,'Angrath''s Rampage',(select id from card_types where card_types = 'Sorcery'),'{B}{R}',2,'','','Choose one —
...
(DEFAULT,452902,'Assassin''s Trophy',(select id from card_types where card_types = 'Instant'),'{B}{G}',2,'','','Destroy target permanent an opponent controls. Its controller may search their library for a basic land card, put it onto the battlefield, then shuffle their library.', (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp(), (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp()),
(DEFAULT,457301,'Bedevil',(select id from card_types where card_types = 'Instant'),'{B}{B}{R}',3,'','','Destroy target artifact, creature, or planeswalker.', (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp(), (SELECT id FROM public.user where username = 'SYSADMIN'), statement_timestamp()),
(DEFAULT,457389,'Blood Crypt',(select id from card_types where card_types = 'Land'),'',0,'','','({T}: Add {B} or {R}.)
